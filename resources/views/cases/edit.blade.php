            ...
            <div class="card-body table-responsive p-0">
                <div class="card">
                    <div class="card-header bg-gradient-navy">
                        <h3 class="card-title">Справа №{{ $case->case_number }} - редагування</h3>
                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control @error('case_number') is-invalid @enderror" id="case_number"
                                                   name="case_number" value="{{ old('case_number', $case->case_number) }}" placeholder="Номер справи">
                                            @error('case_number')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @foreach($categories as $category)
                                                    <option
                                                        value="{{ $category->id }}"
                                                        @if($category->id == $case->category_id) selected @endif
                                        ...
                                        <div class="col-sm-6">
                                            <select name="article_id" id="article_id"
                                                ...
                                                @foreach($articles as $article)
                                                    <option
                                                        value="{{ $article->id }}"
                                                        @if($article->id == $case->article_id) selected @endif
                                                    >{{ $article->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('article_id')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control @error('case_production_number') is-invalid @enderror" id="case_production_number"
                                                   name="case_production_number" value="{{ old('case_production_number', $case->case_production_number) }}" placeholder="Номер провадження">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control @error('google_drive_link') is-invalid @enderror" id="google_drive_link"
                                                   name="google_drive_link" value="{{ old('google_drive_link', $case->google_drive_link) }}" placeholder="Посилання">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control @error('comment') is-invalid @enderror"
                                                      id="comment"
                                                      name="comment" placeholder="Додайте коментар">{{ old('comment', $case->comment) }}</textarea>
                                            @error('comment')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
