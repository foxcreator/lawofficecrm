...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <form class="form" action="{{ route('visitors.update', $visitor->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="visitor_status" id="visitor_status" class="custom-select col-3 @error('visitor_status') is-invalid @enderror">
                            @foreach($status as $key => $stat)
                                <option value="{{ $key }}" @if(old('visitor_status', $visitor->visitor_status) == $key) selected @endif>{{ $stat }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                   name="email" value="{{ old('email', $visitor->email) }}" placeholder="Email">
                            @error('email')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control @error('surname') is-invalid @enderror" id="surname"
                                   name="surname" value="{{ old('surname', $visitor->surname) }}" placeholder="Прізвище">
                            @error('surname')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control @error('father_name') is-invalid @enderror" id="father_name"
                                   name="father_name" value="{{ old('father_name', $visitor->father_name) }}" placeholder="По-батькові">
                            @error('father_name')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group date col-sm-2" id="date">
                            <input type="date" name="birthdate"
                                   ...
                                   value="{{ old('birthdate', $visitor->birthdate) }}"/>
                            @error('birthdate')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                   name="phone" value="{{ old('phone', $visitor->phone) }}" placeholder="+3(099)1234567">
                            @error('phone')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row additional-fields">
                        ...
                        <div class="col-sm-2">
                            <input type="number" class="form-control @error('tin_code') is-invalid @enderror" id="tin_code"
                                   name="tin_code" value="{{ old('tin_code', $visitor->tin_code) }}" placeholder="1112223344" maxlength="10">
                            @error('tin_code')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row additional-fields">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control @error('passport_number') is-invalid @enderror" id="passport_number"
                                   name="passport_number" value="{{ old('passport_number', $visitor->passport_number) }}" placeholder="Номер паспорта" maxlength="10">
                    ...
                    <div class="form-group row additional-fields">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control @error('passport_issued_by') is-invalid @enderror" id="passport_issued_by"
                                   name="passport_issued_by" value="{{ old('passport_issued_by', $visitor->passport_issued_by) }}" placeholder="Кім виданий">
                    ...
                    <div class="form-group row additional-fields">
                        ...
                        <div class="input-group date col-sm-2" id="passport_when_issued">
                            <input type="date" name="passport_when_issued"
                                   ...
                                   value="{{ old('passport_when_issued', $visitor->passport_when_issued) }}"/>
                    ...
                    <div class="form-group row additional-fields">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                                   name="address" value="{{ old('address', $visitor->address) }}" placeholder="Адреса" maxlength="10">
                            @error('address')
                            <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="card-footer">
                    <a href="{{ route('visitor', $visitor->id) }}" type="submit" class="btn btn-default w-25">Відміна</a>
